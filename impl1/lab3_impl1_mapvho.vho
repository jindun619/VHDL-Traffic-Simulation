...
-- ldbanno -n VHDL -o lab3_impl1_mapvho.vho -w -neg -gui -msgset C:/lab3/promote.xml lab3_impl1_map.ncd 
-- Netlist created on Fri Dec 06 03:43:46 2024
-- Netlist written on Fri Dec 06 03:43:48 2024
...
-- entity ccu20004
  ...
  begin
    inst1: CCU2D
      generic map (INIT0 => X"0aaa", INIT1 => X"5999", INJECT1_0 => "NO", 
                   INJECT1_1 => "NO")
      port map (CIN=>CI, A0=>A0, B0=>B0, C0=>C0, D0=>D0, A1=>A1, B1=>B1, 
                C1=>C1, D1=>D1, S0=>S0, S1=>S1, COUT=>CO1);
  end Structure;
...
-- entity SLICE_10
  ...
  begin
    ...
    VitalBehavior : PROCESS (B1_ipd, A1_ipd, A0_ipd, FCI_ipd, F0_out, F1_out, 
      FCO_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE F1_zd         	: std_logic := 'X';
...
-- entity vmuxregsre0019
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity vmuxregsre0019 is
    port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
          SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
          Q: out Std_logic);

    ATTRIBUTE Vital_Level0 OF vmuxregsre0019 : ENTITY IS TRUE;

  end vmuxregsre0019;

  architecture Structure of vmuxregsre0019 is
  begin
    INST01: FL1P3DX
      generic map (GSR => "DISABLED")
      port map (D0=>D0, D1=>D1, SP=>SP, CK=>CK, SD=>SD, CD=>LSR, Q=>Q);
...
-- entity SLICE_38
  ...
  architecture Structure of SLICE_38 is
    ...
    component vmuxregsre0019
      port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
            SP: in Std_logic; CK: in Std_logic; LSR: in Std_logic; 
            Q: out Std_logic);
    end component;
  begin
    i1596_4_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_2_lut_adj_2: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    clk_1s_247: vmuxregsre0019
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_39
  ...
  begin
    i1585_4_lut: lut40020
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_2_lut_adj_5: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    clk_half_249: vmuxregsre0019
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_40
  ...
  begin
    i1149_4_lut: lut40021
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_3_lut_4_lut_adj_6: lut40022
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_42
  ...
  begin
    i1_2_lut_rep_24: lut40024
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1_3_lut_3_lut_4_lut: lut40025
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_43
  ...
  begin
    i1546_4_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1_3_lut_4_lut: lut40026
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_46
  ...
  begin
    i1_2_lut_2_lut: lut40029
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    cur_state_1_bdd_4_lut_1659: lut40030
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_54
  ...
  begin
    i4_4_lut_adj_4: lut40045
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1544_4_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_56
  ...
  begin
    i1_2_lut_rep_33: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1609_2_lut_3_lut_3_lut_4_lut: lut40048
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_58
  ...
  begin
    i1502_2_lut: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1538_4_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_59
  ...
  begin
    i1_2_lut_rep_27_3_lut: lut40049
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1_2_lut_4_lut: lut40050
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_60
  ...
  begin
    i47_2_lut_3_lut_4_lut: lut40051
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1148_GATE: lut40052
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
...
-- entity SLICE_61
  ...
  begin
    i1_2_lut_rep_28_3_lut: lut40053
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity SLICE_62
  ...
  begin
    i2_3_lut_rep_20: lut40055
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i2_3_lut_rep_21_4_lut: lut40013
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_63
  ...
  begin
    i1_2_lut_rep_29_3_lut_4_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i1611_2_lut_3_lut_4_lut: lut40056
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_65
  ...
  begin
    i1605_2_lut_3_lut: lut40057
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1607_2_lut_3_lut_3_lut_4_lut: lut40048
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_66
  ...
  begin
    i1603_3_lut_3_lut_4_lut_4_lut: lut40058
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    i5_4_lut: lut40059
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity SLICE_67
  ...
  begin
    i1592_2_lut_rep_25: lut40060
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    i1540_4_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
  ...
  begin
    ...
    SLICE_5I: SLICE_5
      port map (A1=>clk_halfs_cnt_half_2, A0=>clk_halfs_cnt_half_1, DI1=>n113, 
                ...
                FCO=>n1978);
    SLICE_6I: SLICE_6
      port map (A1=>time_cnt_6, A0=>time_cnt_5, FCI=>n1975, F0=>countdown_5, 
    ...
    SLICE_10I: SLICE_10
      port map (B1=>time_cnt_2, A1=>all_time_2, A0=>time_cnt_1, FCI=>n1973, 
    ...
    SLICE_34I: SLICE_34
      port map (B1=>mode_0, A1=>mode_1, D0=>all_time_7_N_26, C0=>cur_state_0, 
                B0=>cur_state_1, A0=>cur_state_2, DI0=>all_time_3_N_39, 
                CLK=>all_time_7_N_25, F0=>all_time_3_N_39, Q0=>all_time_0, 
                F1=>all_time_7_N_26);
    SLICE_35I: SLICE_35
      port map (B1=>btn1_c, A1=>btn2_c, C0=>cur_state_1, B0=>cur_state_0, 
                A0=>cur_state_2, DI0=>all_time_3_N_31_2, LSR=>all_time_7_N_26, 
                CLK=>all_time_7_N_25, F0=>all_time_3_N_31_2, Q0=>all_time_2, 
                F1=>n2345);
    SLICE_36I: SLICE_36
      port map (D1=>clk_1ss_cnt_9, C1=>clk_1ss_cnt_21, B1=>clk_1ss_cnt_7, 
                A1=>clk_1ss_cnt_13, A0=>cur_state_0, DI0=>n2343, 
                LSR=>cur_state_2, CLK=>all_time_7_N_25, F0=>n2343, 
                Q0=>all_time_3, F1=>n13);
    SLICE_37I: SLICE_37
      port map (D1=>clk_1ss_cnt_20, C1=>clk_1ss_cnt_8, B1=>clk_1ss_cnt_10, 
                A1=>clk_1ss_cnt_3, B0=>cur_state_1, A0=>cur_state_2, DI0=>n190, 
                LSR=>cur_state_0, CLK=>all_time_7_N_25, F0=>n190, Q0=>an1_c, 
                F1=>n2202);
    SLICE_38I: SLICE_38
      port map (D1=>n2200, C1=>n2202, B1=>n2198, A1=>n2247, B0=>n1424, 
                A0=>clk_1s, DI0=>clk_1s_N_209, CLK=>clk_c, F0=>clk_1s_N_209, 
                Q0=>clk_1s, F1=>n1424);
    SLICE_39I: SLICE_39
      port map (D1=>clk_halfs_cnt_half_17, C1=>n12_adj_3, 
                B1=>clk_halfs_cnt_half_20, A1=>n13_adj_2, B0=>n1423, 
                A0=>clk_half, DI0=>clk_half_N_210, CLK=>clk_c, 
                F0=>clk_half_N_210, Q0=>clk_half, F1=>n1423);
    SLICE_40I: SLICE_40
      port map (D1=>n14, C1=>cur_state_1, B1=>n1778, A1=>n13_adj_1, D0=>n2333, 
                C0=>cur_state_0, B0=>n2340, A0=>cur_state_2, DI1=>n230, 
                DI0=>n2159, CE=>clk_c_enable_12, LSR=>n1162, CLK=>clk_c, 
                F0=>n2159, Q0=>cur_state_0, F1=>n230, Q1=>cur_state_1);
    SLICE_41I: SLICE_41
      port map (B1=>mode_0, A1=>mode_1, D0=>mode_1, C0=>btn4_c, B0=>btn3_c, 
                A0=>mode_0, DI0=>n14_adj_22, CE=>clk_c_enable_12, LSR=>n1162, 
                CLK=>clk_c, F0=>n14_adj_22, Q0=>cur_state_2, F1=>n2344);
    SLICE_42I: SLICE_42
      port map (B1=>countdown_4, A1=>countdown_1, D0=>cur_state_1, 
                C0=>cur_state_2, B0=>clk_half, A0=>cur_state_0, 
                DI0=>green1_N_205, CLK=>all_time_7_N_25, F0=>green1_N_205, 
                Q0=>green1_c, F1=>n2337);
    SLICE_43I: SLICE_43
      port map (D1=>clk_halfs_cnt_half_5, C1=>clk_halfs_cnt_half_16, 
                B1=>clk_halfs_cnt_half_1, A1=>clk_halfs_cnt_half_14, 
                D0=>cur_state_1, C0=>cur_state_2, B0=>clk_half, 
                A0=>cur_state_0, DI0=>green2_N_207, CLK=>all_time_7_N_25, 
                F0=>green2_N_207, Q0=>green2_c, F1=>n2206);
    SLICE_44I: SLICE_44
      port map (B1=>btn3_c, A1=>btn2_c, A0=>btn2_c, DI1=>mode_1_N_166_1, 
                DI0=>mode_1_N_166_0, CE=>clk_c_enable_13, LSR=>n162, 
                CLK=>clk_c, F0=>mode_1_N_166_0, Q0=>mode_0, F1=>mode_1_N_166_1, 
                Q1=>mode_1);
    SLICE_45I: SLICE_45
      port map (B1=>mode_0, A1=>mode_1, C0=>clk_half, B0=>cur_state_0, 
                A0=>cur_state_2, DI0=>n1573, LSR=>cur_state_1, 
                CLK=>all_time_7_N_25, F0=>n1573, Q0=>red1_c, 
                F1=>all_time_7_N_25);
    SLICE_46I: SLICE_46
      port map (B1=>countdown_3, A1=>cur_state_0, D0=>cur_state_2, 
                C0=>clk_half, B0=>cur_state_0, A0=>cur_state_1, 
                DI0=>red2_N_206, CLK=>all_time_7_N_25, F0=>red2_N_206, 
                Q0=>red2_c, F1=>n152);
    i1635_SLICE_47I: i1635_SLICE_47
      port map (C1=>unit_0, B1=>countdown_1, A1=>countdown_2, D0=>unit_0, 
                C0=>countdown_1, B0=>countdown_2, A0=>countdown_4, 
                M0=>countdown_3, OFX0=>a_to_g0_c_6);
    i1633_SLICE_48I: i1633_SLICE_48
      port map (D1=>countdown_4, C1=>countdown_2, B1=>countdown_3, 
                A1=>countdown_1, C0=>countdown_2, B0=>countdown_3, 
                A0=>countdown_1, M0=>unit_0, OFX0=>a_to_g0_c_3);
    i1627_SLICE_49I: i1627_SLICE_49
      port map (B1=>countdown_2, A1=>countdown_1, D0=>countdown_4, C0=>unit_0, 
                B0=>countdown_2, A0=>countdown_1, M0=>countdown_3, 
                OFX0=>a_to_g0_c_0);
    i1625_SLICE_50I: i1625_SLICE_50
      port map (D1=>countdown_4, C1=>countdown_3, B1=>countdown_2, A1=>unit_0, 
                C0=>countdown_3, B0=>countdown_2, A0=>unit_0, M0=>countdown_1, 
                OFX0=>a_to_g0_c_1);
    i1641_SLICE_51I: i1641_SLICE_51
      port map (D1=>countdown_1, C1=>countdown_3, B1=>unit_0, A1=>countdown_4, 
                D0=>countdown_1, C0=>countdown_3, B0=>unit_0, A0=>countdown_4, 
                M0=>countdown_2, OFX0=>a_to_g0_c_4);
    i1639_SLICE_52I: i1639_SLICE_52
      port map (D1=>countdown_2, C1=>unit_0, B1=>countdown_1, A1=>countdown_3, 
                D0=>countdown_2, C0=>unit_0, B0=>countdown_1, A0=>countdown_3, 
                M0=>countdown_4, OFX0=>a_to_g0_c_2);
    i1621_SLICE_53I: i1621_SLICE_53
      port map (C1=>countdown_1, B1=>countdown_3, A1=>unit_0, D0=>countdown_1, 
                C0=>countdown_3, B0=>unit_0, A0=>countdown_4, M0=>countdown_2, 
                OFX0=>a_to_g0_c_5);
    SLICE_54I: SLICE_54
      port map (D1=>n2204, C1=>n2206, B1=>n2214, A1=>clk_halfs_cnt_half_8, 
                D0=>clk_halfs_cnt_half_3, C0=>clk_halfs_cnt_half_18, 
                B0=>clk_halfs_cnt_half_7, A0=>clk_halfs_cnt_half_15, F0=>n2204, 
                F1=>n12_adj_3);
    SLICE_55I: SLICE_55
      port map (C1=>countdown_7, B1=>countdown_6, A1=>countdown_5, D0=>n1766, 
                C0=>countdown_1, B0=>countdown_4, A0=>n9, F0=>n14, F1=>n9);
    SLICE_56I: SLICE_56
      port map (B1=>btn4_c, A1=>btn3_c, D0=>n1424, C0=>clk_1s, B0=>n2345, 
                A0=>n2346, F0=>clk_c_enable_13, F1=>n2346);
    SLICE_57I: SLICE_57
      port map (D1=>clk_1ss_cnt_4, C1=>clk_1ss_cnt_19, B1=>clk_1ss_cnt_15, 
                A1=>clk_1ss_cnt_18, D0=>clk_1ss_cnt_12, C0=>n12, 
                B0=>clk_1ss_cnt_14, A0=>n13, F0=>n2247, F1=>n12);
    SLICE_58I: SLICE_58
      port map (B1=>clk_1ss_cnt_16, A1=>clk_1ss_cnt_22, D0=>n2162, 
                C0=>clk_1ss_cnt_11, B0=>clk_1ss_cnt_17, A0=>clk_1ss_cnt_2, 
                F0=>n2198, F1=>n2162);
    SLICE_59I: SLICE_59
      port map (C1=>mode_1, B1=>btn4_c, A1=>btn3_c, D0=>n2340, C0=>countdown_2, 
                B0=>n2337, A0=>n9, F0=>n200, F1=>n2340);
    SLICE_60I: SLICE_60
      port map (D1=>mode_1, C1=>cur_state_2, B1=>btn4_c, A1=>btn3_c, 
                C0=>unit_0, B0=>n128, A0=>n1766, F0=>n1778, F1=>n1766);
    SLICE_61I: SLICE_61
      port map (C1=>mode_1, B1=>btn4_c, A1=>btn3_c, D0=>n200, C0=>n2341, 
                B0=>n152, A0=>cur_state_2, F0=>n128, F1=>n2341);
    SLICE_62I: SLICE_62
      port map (C1=>unit_0, B1=>n2334, A1=>countdown_3, D0=>n9, 
                C0=>countdown_2, B0=>countdown_4, A0=>countdown_1, F0=>n2334, 
                F1=>n2333);
    SLICE_63I: SLICE_63
      port map (D1=>btn2_c, C1=>btn1_c, B1=>btn4_c, A1=>btn3_c, D0=>n2333, 
                C0=>n2342, B0=>n1424, A0=>clk_1s, F0=>n1719, F1=>n2342);
    SLICE_64I: SLICE_64
      port map (D1=>clk_halfs_cnt_half_9, C1=>clk_halfs_cnt_half_0, 
                B1=>clk_halfs_cnt_half_4, A1=>clk_halfs_cnt_half_2, 
                D0=>clk_halfs_cnt_half_19, C0=>clk_halfs_cnt_half_21, 
                B0=>n2208, A0=>clk_halfs_cnt_half_10, F0=>n2214, F1=>n2208);
    SLICE_65I: SLICE_65
      port map (C1=>btn1_c, B1=>n1424, A1=>clk_1s, D0=>n1424, C0=>clk_1s, 
                B0=>btn1_c, A0=>btn2_c, F0=>n1162, F1=>n162);
    SLICE_66I: SLICE_66
      port map (D1=>countdown_1, C1=>countdown_3, B1=>countdown_4, 
                A1=>countdown_2, D0=>cur_state_0, C0=>countdown_2, 
                B0=>countdown_3, A0=>unit_0, F0=>n13_adj_1, F1=>a_to_g1_c_1);
    SLICE_67I: SLICE_67
      port map (B1=>n1424, A1=>clk_1s, D0=>clk_1ss_cnt_1, C0=>clk_1ss_cnt_5, 
                B0=>clk_1ss_cnt_0, A0=>clk_1ss_cnt_6, F0=>n2200, 
                F1=>clk_c_enable_12);
    SLICE_68I: SLICE_68
      port map (D0=>clk_halfs_cnt_half_13, C0=>clk_halfs_cnt_half_6, 
                B0=>clk_halfs_cnt_half_12, A0=>clk_halfs_cnt_half_11, 
